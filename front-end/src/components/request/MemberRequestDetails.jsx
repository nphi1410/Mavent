    ...
    return (
      <span
        className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${
          statusStyles[status.toLowerCase()] || "bg-gray-500 text-white"
        }`}
      >
        {status}
      </span>
        ...
        <div className="p-6 flex justify-between border-b border-gray-300">
          <div className="flex items-center">
            <h2 className="text-2xl font-semibold text-gray-800">
              Request Details - {data.requestByUsername}
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg p-4 shadow-sm h-full">
                ...
                <textarea
                  className="text-gray-700 leading-relaxed w-full h-7/10"
