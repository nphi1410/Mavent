...
import { 
  faUser, faEdit, faBan, faEye, faTrash
    ...
    <div className="hidden lg:block">
      <div className="overflow-x-auto" ref={tableRef}>
        <table className="min-w-full divide-y divide-gray-200">          <thead className="bg-gray-50">
          ...
          <tbody className="bg-white divide-y divide-gray-200">            {members.map(member => (
              <tr 
                key={member.id} 
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <div className="flex justify-end items-center space-x-2">                    {/* Special case for admin users - always show all actions */}
                    ...
                    {true || (userRole === 'ADMIN' || sessionStorage.getItem('userRole') === 'ADMIN') ? (
                      <>
                        ...
                        <button 
                          ...
                          className={`p-1 transition-colors duration-200 ${bannedUsers && bannedUsers[member.id] ? 'text-green-600 hover:text-green-800' : 'text-red-600 hover:text-red-800'}`}
                          title={(bannedUsers && bannedUsers[member.id]) ? 'Unban Member' : 'Ban Member'}
