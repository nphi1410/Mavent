  ...
  useEffect(() => {
    if (department) {
      setFormData({
        ...
        sponsorManageable: department.sponsorManageable || false,
      });
    } else {
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              <input
                ...
                value={
                  isEditMode
                    ? formData.deptNo ||
                      `DEPT-${String(department?.departmentId || "").padStart(
                        3,
                        "0"
                      )}`
                    : "DEPT-XXX "
          ...
          <div className="flex justify-end gap-3">
            <label className="inline-flex items-center space-x-2 text-sm text-gray-700">
              <input
                type="checkbox"
                name="sponsorManageable"
                checked={formData.sponsorManageable}
                onChange={handleChange}
                className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <span>Sponsor Manageable</span>
            </label>
