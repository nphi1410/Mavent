...
const CreateIncomeModal = ({ eventId, eventName, onClose, onSuccess }) => { // Thêm eventName vào props
    ...
    return (
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50 backdrop-blur-sm">
            <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md relative">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Tạo Khoản Thu nhập Mới</h2>
                <button
                    onClick={onClose}
