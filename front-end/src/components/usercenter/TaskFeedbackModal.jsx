...
const TaskFeedbackModal = ({ taskId, isOpen, onClose, taskData }) => {
    ...
    useEffect(() => {
        if (isOpen && taskId) {
            ...
            if (taskData) {
                console.log("Task data provided, fetching event documents if available");
    ...
    const fetchEventDocuments = async () => {
        ...
        if (!taskData?.eventId) {console.log("error");
         return;}
        try {
            console.log("load ok");
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                {loadingDocuments ? (
                                    ...
                                    <p className="text-gray-500 italic text-sm text-center py-6">No documents attached to this task.</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {showUploadForm && (
                                    <div className="mb-4 border border-gray-200 rounded-lg p-4 bg-gray-50">
                                        <h4 className="font-medium mb-3 text-sm">Upload New Document</h4>
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex space-x-2">
                                                ...
                                                >
                                                    {uploadingDocument ? 'Uploading...' : 'Upload & Attach'}
                                                </button>
                                                <button
                                                    type="button"
