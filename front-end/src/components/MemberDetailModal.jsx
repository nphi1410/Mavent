  ...
  if (!isOpen || !user) {
    ...
    return (
      <div style={{ display: "none" }}>
        Modal would render here if isOpen={String(isOpen)} and user exists=
        {String(!!user)}
      </div>
    );
  }
    ...
    >
      ...
      >
          ...
          <div className="ml-4">
            <h3
              className={`text-xl font-semibold ${
                isBanned ? "line-through text-red-500" : ""
              }`}
            >
              {user.name}
            </h3>
        ...
        <div className="p-6 flex space-x-3 bg-gray-50">
          {" "}
          {/* Edit button - always enabled to fix the issue */}
          <button
