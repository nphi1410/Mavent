                    ...
                    {isSubmitted ? (
                        <div className="text-center bg-white shadow-lg rounded-xl p-6">
                            ...
                            <div className="flex justify-center space-x-1 mb-2 text-yellow-400">
                                {[1, 2, 3, 4, 5].map((s) => (
                                    <FontAwesomeIcon key={s} icon={faStarSolid} className={s <= rating ? '' : 'text-gray-300'} />
                                ))}
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-2xl overflow-hidden">
                            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 text-white">
                                ...
                                <p className="text-purple-100">Chia sẻ trải nghiệm của bạn để giúp chúng tôi cải thiện</p>
                            </div>
                            <div className="p-6 space-y-6">
                                {/* Star */}
                                <div className="text-center">
                                    <p className="text-gray-700 font-medium mb-2">Mức độ hài lòng</p>
                                    <div className="flex justify-center space-x-3">
                                        {[1, 2, 3, 4, 5].map((s) => (
                                            ...
                                            >
                                                <FontAwesomeIcon
                                                    icon={faStarSolid}
                                                    className={`text-3xl transition-all duration-200 ${s <= (hoverRating || rating) ? 'text-yellow-400' : 'text-gray-300'}`}
                                                />
                                            </button>
                                        ))}
                                    </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        maxLength={1000}
                                    />
                                    <div className="text-sm text-right mt-1 text-gray-500">{comment.length}/1000</div>
                            ...
                            <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                                <p className="text-sm text-blue-700 text-center">
                                    💡 Đánh giá của bạn sẽ giúp chúng tôi tổ chức các sự kiện tốt hơn trong tương lai
                                </p>
                            </div>
                        </form>
                    )}
