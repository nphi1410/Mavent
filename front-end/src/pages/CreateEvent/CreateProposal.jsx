...
const CreateProposal = ({ isUpdatePage = false }) => {
                ...
                try {
                    ...
                    if (proposalData) {
                        setProposals({
                            ...
                            defenseDate: proposalData.defenseDate
                                ? vietnameseDate(proposalData.defenseDate, false, true)
                                : "",
                        });
                    }
                } catch (error) {
    ...
    const handleChange = (field, value) => {
        ...
        if (field === "proposalLink") {
            if (!isValidURL(value)) {
                setErrors((prev) => ({
                    ...prev,
                    proposalLink: "Please enter a valid link (https://...)",
                }));
            } else {
    ...
    const handleSaveProposal = async () => {
        try {
            const { proposalTitle, proposalDescription, proposalLink, defenseDate } =
                proposals;
        ...
        <div className="min-h-screen bg-green-50 px-4 py-8">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="mt-2 text-gray-600">
                    Provide your proposal details for the event
                </p>
            ...
            <div className="max-w-4xl mx-auto mt-10 bg-white p-6 rounded-xl shadow">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            className={`w-full border ${errors.proposalLink ? "border-red-500" : "border-gray-300"
                                } rounded-lg p-2`}
                    ...
                    <div className="md:col-span-2">
                        ...
                        <textarea
                            ...
                            onChange={(e) =>
                                handleChange("proposalDescription", e.target.value)
                            }
                        />
                    </div>
