...
const SuperAdminDashboard = () => {
  ...
  const statsConfig = [
    ...
    },
    {
      ...
      onClick: () => {
        setShowEventChart(false);
        setSelectedStatIndex(1);
      },
    },
    {
      key: "upcomingEvents",
    ...
    datasets: [
      {
        label:
          selectedMonthIndex !== null
            ? `Events in ${monthNames[selectedMonthIndex]}`
            : "",
        data:
          selectedMonthIndex !== null
            ? getWeeklyCountsForMonth(selectedMonthIndex)
            : [],
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-6">
            {statsConfig.map((stat, i) => (
              <div
                ...
                className={`bg-zinc-100 p-6 rounded-xl shadow ${
              ...
              <div className="mb-4">
                ...
                >
                  {[
                    ...new Set(
                      events.map((ev) =>
                        new Date(ev.startDatetime).getFullYear()
                      )
                    ),
                  ]
                    .sort((a, b) => b - a)
