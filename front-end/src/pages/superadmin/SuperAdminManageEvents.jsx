    ...
    <div className="py-10 w-full">
      ...
      <div className="border border-gray-200 rounded-lg p-4 bg-white">
        ...
        <p className="text-sm text-gray-500 mb-4">
          View and manage all your events from one place
        </p>
        ...
        <div className="flex relative w-full">
          ...
          {totalPages > 1 && (
            <div className="flex items-center mt-4 space-x-2">
              <button
                ...
                className={`hover:cursor-pointer px-3 py-1 border rounded ${
                  currentPage === 1
          ...
          <div className="ml-auto mt-4">
            <button
              className={`hover:scale-105 hover:cursor-pointer bg-blue-600 hover:bg-blue-700 transition text-white font-semibold py-2 px-4 rounded text-sm sm:text-base ${
