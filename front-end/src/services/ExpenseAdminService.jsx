...
export const fetchTotalExpenseByEventId = async (eventId) => {
    try {
        const response = await Api.get(`/expenses/total-by-event/${eventId}`);
...
export const fetchExpensesByCategoryForEvent = async (eventId) => {
    try {
        const response = await Api.get(`/expenses/by-category/event/${eventId}`);
        return response.data;
    } catch (error) {
...
export const fetchExpensesByDepartmentForEvent = async (eventId) => {
    try {
        const response = await Api.get(`/expenses/by-department/event/${eventId}`);
        return response.data;
    } catch (error) {
...
export const fetchDistinctPaymentMethodsByEventId = async (eventId) => {
    try {
        const response = await Api.get(`/expenses/payment-methods/event/${eventId}`);
        return response.data;
    } catch (error) {
...
export const fetchExpenseCountByStatusForEvent = async (eventId) => {
    try {
        const response = await Api.get(`/expenses/count-by-status/event/${eventId}`);
        return response.data;
    } catch (error) {
