...
const useMemberModals = () => {
  ...
  const toggleMenu = useCallback(
    (userId) => {
      ...
      setActiveMenu(
        userId === null ? null : activeMenu === userId ? null : userId
      );
    },
    [activeMenu]
  );
  ...
  const openEditModal = useCallback(
    (user) => {
      ...
      // Use setTimeout to verify state was updated
      setTimeout(() => {
        // console.log('Edit modal states updated:', {
        //   showEditModal,
        //   isEditModalOpen,
        //   editedUser: editedUser ? `${editedUser.name} (ID: ${editedUser.id})` : null
        // });
  ...
  const closeEditModal = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      // Check if state was properly updated
      setTimeout(() => {
        // console.log("Edit modal state after closing:", {
        //   showEditModal,
        //   isEditModalOpen,
        //   editedUser
        // });
  ...
  const handleEditInputChange = useCallback(
    (field, value, availableDepartments = []) => {
      ...
      setEditedUser((prev) => {
        ...
        if (
          ...
          const partialMatch = availableDepartments.find(
            (dept) =>
